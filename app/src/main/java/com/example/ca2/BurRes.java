...
//displaying tabs
    ...
    private class MyPagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int pos) {
            switch (pos) {
                case 0: {
                    return IngredientFragment.newInstance("fragment 1");
                }
                case 1: {

                    return DirectionFragment.newInstance("fragment 2");
                }
                default:
                    return DirectionFragment.newInstance("fragment 1, Default");
            }
        }
